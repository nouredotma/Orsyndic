...
export default function RegisterPage() {
  ...
  useEffect(() => {
    if (isAuthenticated()) {
      ...
      if (pathname !== "/syndic-demo/register") {
  ...
  return (
    <div className="flex min-h-screen flex-col md:flex-row">
      ...
      <div className="relative hidden md:flex md:w-1/2 overflow-hidden">
        <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: `url('https://images.unsplash.com/photo-1732194516739-9325055c35de?q=80&w=897&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')` }}></div>
      ...
      <div className="flex flex-1 flex-col items-center justify-center p-6 md:w-1/2 overflow-y-auto relative">
        ...
        <div className="w-full max-w-md space-y-6 py-4">
          ...
          <div className="mt-2 text-center text-sm">
            ...
            <Link href="/syndic-demo/login" className="font-medium text-primary underline underline-offset-4">{t.register.login}</Link>
          </div>
        </div>
      </div>
    </div>
