        ...
        <div className="bg-black rounded-sm px-5 py-10 md:px-20 md:py-12 ">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            ...
            <div className="text-left">
              ...
              <h3 className="text-md font-semibold tracking-tight text-white mb-1 md:mb-2">{t.cta.features.engaging.title}</h3>
            ...
            <div className="text-left">
              ...
              <h3 className="text-md font-semibold tracking-tight text-white mb-1 md:mb-2">{t.cta.features.secure.title}</h3>
              <p className="text-white/70 text-xs md:text-sm">
            ...
            <div className="text-left">
              ...
              <h3 className="text-md font-semibold tracking-tight text-white mb-1 md:mb-2">{t.cta.features.scale.title}</h3>
              <p className="text-white/70 text-xs md:text-sm">
